...
export const VitalsTab = ({ careTeamId }: VitalsTabProps) => {
    ...
    const handleAddVital = async () => {
        try {
            ...
            if (formData.weight) {
                vitalData.weight = parseFloat(formData.weight);
                vitalData.weight_unit = formData.weight_unit;
            }
            if (formData.blood_pressure_systolic) {
                vitalData.blood_pressure_systolic = parseInt(formData.blood_pressure_systolic);
            }
            if (formData.blood_pressure_diastolic) {
                vitalData.blood_pressure_diastolic = parseInt(formData.blood_pressure_diastolic);
            }
            if (formData.heart_rate) {
                vitalData.heart_rate = parseInt(formData.heart_rate);
            }
            if (formData.temperature) {
                vitalData.temperature = parseFloat(formData.temperature);
                vitalData.temperature_unit = formData.temperature_unit;
            }
            if (formData.blood_sugar) {
                vitalData.blood_sugar = parseInt(formData.blood_sugar);
            }
            if (formData.oxygen_saturation) {
                vitalData.oxygen_saturation = parseInt(formData.oxygen_saturation);
            }
            if (formData.notes) {
                vitalData.notes = formData.notes;
            }
            ...
            toast({
                title: "Success",
                description: "Health vitals recorded successfully",
            });
            ...
            toast({
                title: "Error",
                description: "Failed to record health vitals",
                variant: "destructive",
            });
        }
    };
